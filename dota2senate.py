...
if __name__ == "__main__":
    ...
    print(s.predictPartyVictory("DRRDRDRDRDDRDRDR")) # Radiant
    print(s.predictPartyVictory("DDRRR")) # Dire
    print(s.predictPartyVictory("RDDR")) # Dire
    print(s.predictPartyVictory("RRDDD")) # Radiant